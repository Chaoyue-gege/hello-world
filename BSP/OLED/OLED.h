...
void uOLED_6x8Str(unsigned char x, unsigned char y, unsigned char ch[]);
void uOLED_8x16Str(unsigned char x, unsigned char y, unsigned char ch[]);
void uOLED_16x16CN(unsigned char x, unsigned char y, unsigned char N);
void uOLED_BMP(unsigned char x0, unsigned char y0, unsigned char x1, unsigned char y1, unsigned char BMP[]);
